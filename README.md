...
**วิธีการรันโปรแกรม**
1. เพิ่ม Code cellและรัน cell 1.py
2. เพิ่ม Code cellและรัน temperature.py
3. เพิ่ม Code cellและรัน weight.py
4. เพิ่ม Code cellและรัน time.py
5. เพิ่ม Code cellและรัน length.py
6. เพิ่ม Code cellและรัน volume.py
7. เพิ่ม Code cellและรัน cell 2.py
8. เพิ่ม Code cellและรัน cell 3.py
9. เพิ่ม Code cellและรัน cell 4.py (optional: รันเพื่อทดสอบบันทึก Test Case การแปลงหน่วยลง Google sheet)
10. เพิ่ม Code cellและรัน cell 5.py (optional: รันเพื่อทดสอบบันทึก Test Case การแปลงหน่วยลง Google sheet)
11. เพิ่ม Code cellและรัน main.py
